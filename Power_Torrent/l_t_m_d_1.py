...
class LTMD_1:
    ...
    def __init__(self):
        ...
        self.first_50_unit_charges = 150
        self.next_30_unit_charges = 185
        self.remaining_unit_charges = 245
    ...
    def total_lmtd_1_charges(self, energy_charges, fixed_charges, power_factor_charge):
    ...
    def ltmd_1(self):
        try:
            if self.unit > 15:
                ...
                print("\nLTMD-1 : Low Tension Maximum Demand for Residential Purpose")
                self.total_lmtd_1_charges(self.energy_charges, self.fixed_charges, self.power_factor_charges)
            else:
